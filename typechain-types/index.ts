...
export type { DataToken } from "./contracts/DataOwnerToken.sol/DataToken";
export { DataToken__factory } from "./factories/contracts/DataOwnerToken.sol/DataToken__factory";
