...
export declare namespace DataToken {
  export type TokenMetadataStruct = { cid: string; owner: AddressLike };

  export type TokenMetadataStructOutput = [cid: string, owner: string] & {
    cid: string;
    owner: string;
  };
}
...
export interface DataToken extends BaseContract {
  ...
  getTokenMetadata: TypedContractMethod<
    ...
    [DataToken.TokenMetadataStructOutput],
    "view"
  >;
  ...
  tokenMetadata: TypedContractMethod<
    [arg0: BigNumberish],
    [[string, string] & { cid: string; owner: string }],
    "view"
  >;
